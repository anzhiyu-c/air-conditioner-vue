 ...
 * @LastEditTime: 2022-11-29 21:02:45
 * @LastEditors: 安知鱼
 */
...
export { DEFAULT_PLUGIN_OPTIONS };
export type { IRipplePluginOptions, IRippleDirectiveOptions, IRippleDirectiveOptionWithBinding };
